  ...
  render() {
    return (
      <div className="about">
        ...
        <p id="why-long" className="collapsed">
          ...
          the trend for wine-and-music pairings. For me, however, the latter is not a great match: while it is certainly
          enjoyable to listen to music while drinking wine, most music changes quite quickly to be a "true" match. A
          three-minute rock song is too brief for a glass of wine; a twenty-minute classical piece will change tempo and
          style quite a lot. As for movies and books, they require too much concentration; it seems to me that one can
          focus on either one or the other.
          <br />
          <br />
          ...
          wine, the art itself remains the same, but layers of initially hidden complexity are revealed to the attentive
          observer. Simultaneously, the static nature of the medium means that it is easy to dip in and out of the one
          to the other, for a truly matching multi-sensory experience.
          <br />
          <br />
          ...
          <br />
          <br />
          So, come and join me! You might find you enjoy paintings (or wine!) more than you thought!
        </p>
